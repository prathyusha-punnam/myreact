  ...
  return (
    ...
    <div className='Contact-container'>
      <div className='Contact-details contact-design'>
          ...
          <div><h3><i class="fa-solid fa-envelope fa-2x"></i><span> prathyusha.punnam@gmail.com</span></h3></div>
          <div><h3><i class="fa-solid fa-phone-flip fa-2x"></i><span>6300323876</span></h3></div>
